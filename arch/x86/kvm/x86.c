				      ...
				      void **data)
{
	...
	if (!kvm_x86_ops.do_keepalive_pi)
		return -ENOTSUPP;

	return kvm_x86_ops.do_keepalive_pi(irqfd->kvm, irqfd->gsi, data, true);
}
					 ...
					 void **data)
{
	...
	return kvm_x86_ops.do_keepalive_pi(irqfd->kvm, irqfd->gsi, data, false);
}
